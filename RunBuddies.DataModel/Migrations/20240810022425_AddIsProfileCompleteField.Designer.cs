...
namespace RunBuddies.DataModel.Migrations
{
    ...
    [Migration("20240810022425_AddIsProfileCompleteField")]
    partial class AddIsProfileCompleteField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunBuddies.DataModel.Club", b =>
                {
                    ...
                    b.Property<string>("CommunicationGroupLink")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RunBuddies.DataModel.EventParticipant", b =>
                {
                    b.Property<int>("EventID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RunBuddies.DataModel.LeaderboardEntry", b =>
                {
            ...
            modelBuilder.Entity("RunBuddies.DataModel.LeaderboardEntry", b =>
                {
                    b.HasOne("RunBuddies.DataModel.Leaderboard", "Leaderboard")
                        .WithMany("Entries")
